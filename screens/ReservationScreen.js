...
const ReservationScreen = () => {
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: () => {
            presentLocalNofication(date.toLocaleDateString("en-US"));
            resetForm();
          },
        },
      ],
  ...
  const presentLocalNofication = async (reservationDate) => {
      ...
      <Animatable.View animation="zoomIn" duration={2000} delay={1000}>
        ...
        <View style={styles.formRow}>
          <Button
            ...
            color="#5637DD"
            accessibilityLabel="Tap me to seach for availability"
          />
        </View>
      </Animatable.View>
    </ScrollView>
